...
/**
 * @file
 * Contains \Drupal\sak\Controller\sakController.
 */

namespace Drupal\sak\Controller;

use Drupal\Core\Controller\ControllerBase;
use Symfony\Component\HttpFoundation\JsonResponse;

/**
 * sakController for the sak module.
 */
class sakController extends ControllerBase {
  ...
  public function render_json($api_key, $id) {
    ...
    $site_api_key = \Drupal::config('sak.settings')->get('sakkey');
